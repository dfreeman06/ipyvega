...
# -*- coding: utf-8 -*-
#
# ipyvega documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyvega', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipyvega.tex', 'ipyvega Documentation',
     'Dane Freeman', 'manual'),
]
